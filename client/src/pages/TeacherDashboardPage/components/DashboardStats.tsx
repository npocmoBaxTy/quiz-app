...
export const DashboardStats = ({ data }: { data: Quiz[] }) => {
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
      <StatCard
        title={t("teacherDashboard.stats.activeQuizzes")}
      ...
      />
      <StatCard
        title={t("teacherDashboard.stats.totalStudents")}
      ...
      />
      <StatCard
        title={t("teacherDashboard.stats.avgScore")}
      ...
      />
      <StatCard
        title={t("teacherDashboard.stats.drafts")}
        value={data.filter((quiz) => !quiz.published).length}
        icon={FileText}
